...
export type MajorToKP = $ModelResult<$Schema, "MajorToKP">;
...
export type CLO = $TypeDefResult<$Schema, "CLO">;
...
export const BKPCategory = $schema.enums.BKPCategory.values;
export type BKPCategory = (typeof BKPCategory)[keyof typeof BKPCategory];
